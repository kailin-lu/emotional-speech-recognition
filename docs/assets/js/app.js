...
const WEIGHTS_URL = 'https://storage.googleapis.com/klu-models/web_lstm_model/weights_manifest.json';
const MODEL_URL = 'https://storage.googleapis.com/klu-models/web_lstm_model/tensorflowjs_model.pb';
